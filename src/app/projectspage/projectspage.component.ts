...
export class ProjectspageComponent {
  projectList: ProjectData[] = [
    ...
    },
    {
      ...
      toolsUsed: ['Spring Boot', 'Angular', 'Gemini API'], githubUrl:"https://github.com/AyushmanJena/project-idea-generator", liveUrl: "https://ayushmanjena.github.io/project-idea-generator/", imageUrl:"/project-images/projectidea_screenshot.png"
    },
    {
      ...
      toolsUsed: ['Angular'], githubUrl:"https://github.com/AyushmanJena/color-picker-game", liveUrl: "https://ayushmanjena.github.io/color-picker-game/", imageUrl:"/project-images/tictactoe_screenshot.png"
    },
    {
      ...
      toolsUsed: ['Spring Boot', 'Thymeleaf', 'Gemini API', 'Youtube API'], githubUrl:"https://github.com/AyushmanJena/Youtube-comments-analyzer", liveUrl: "", imageUrl:"/project-images/youtube_screenshot.png"
    },
    {
      title: "Color Memory Game", description:"Recreate the color from memory as similar as possible.",
      toolsUsed: ['Angular'], githubUrl:"https://github.com/AyushmanJena/color-picker-game", liveUrl: "https://ayushmanjena.github.io/color-picker-game/", imageUrl:"/project-images/colormemory_screenshot.png"
    },
